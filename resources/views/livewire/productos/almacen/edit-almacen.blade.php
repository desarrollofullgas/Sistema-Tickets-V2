                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3 justify-evenly items-center">
                            <div>
                                ...
                                <x-input wire:model.defer="stock" type="number" name="stock" id="stock" required
                                    autofocus autocomplete="stock" min=0 />
                                <x-input-error for="stock"></x-input-error>
                            </div>
                            <div>
                                <x-label value="{{ __('Stock base') }}" for="base" />
                                <x-input wire:model.defer="base" type="number" name="base" id="base" required
                                    autofocus autocomplete="base" min=0 />
                                <x-input-error for="base"></x-input-error>
                            </div>
                        </div>
                    </div>
                    <div name="footer" class="d-none text-right mt-3">
                        <x-danger-button class="mr-2" wire:click="updateAlmacen({{ $idAlma }})"
