        ...
        <div class="flex items-center justify-center min-h-screen px-4 text-center md:items-center sm:p-0">
            ...
            >
                ...
                <div class="flex items-center justify-between space-x-4">
                    <h1 class="text-xl font-medium">Eliminar servicio</h1>
                </div>
                <div class="flex flex-col justify-center gap-2 py-3">
                    ...
                    <span class="text-center">¿Está seguro de eliminar este servicio?</span>
                </div>
                <div name="footer" class="d-none text-right mt-1">
                    <x-danger-button class="mr-2" wire:click="deleteServicio({{$servicioID}})" wire:loading.attr="disabled">
                        Aceptar
                    </x-danger-button>
