        ...
        @if ($servicio)
            ...
            @if ($servicio->fallas->count() > 0)
                    <div class="border rounded-lg  max-h-[320px] overflow-auto dark:border-gray-700">
                        <details>
                            <summary class="bg-gray-100 py-2 px-4 cursor-pointer dark:bg-slate-700 dark:text-gray-300 dark:border-gray-700">Click para mostrar/ocultar Fallas del Servicio</summary>
                            <table class="w-full">
                                <thead>
                                    <tr>
