<div>
    <button wire:click="editServicio({{$servicioID}})" wire:loading.attr="disabled" class="tooltip">
            ...
            <x-slot name="content">
                <div class="flex flex-wrap gap-3 justify-evenly items-center">
                    ...
                    <div>
                        ...
                        class="select-estaciones form-select form-control border-gray-300 rounded-md dark:bg-slate-800 dark:border-gray-700 dark:text-white">
