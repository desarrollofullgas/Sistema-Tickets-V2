<div>
    <div class="py-4 space-y-4">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            {{-- Barra de Busqueda --}}
            <div>
                <x-input wire:model="search" type="text" class="w-full md:w-auto" placeholder="Buscar tareas..." />
            </div>
            {{-- Acciones Masivas --}}
            @if ($checked)
                ...
                <x-slot name="body">
                    @forelse($tareas as $tarea)
                        ...
                        <x-row wire:loading.class.delay="opacity-75">
                            ...
                            <x-cell>
                                <div
                                    class="rounded bg-{{ $tarea->status_color }}-200 py-1 px-3 text-xs text-center text-{{ $tarea->status_color }}-500 font-bold">
                                    {{ $tarea->status }}
                                </div>
                            </x-cell>
