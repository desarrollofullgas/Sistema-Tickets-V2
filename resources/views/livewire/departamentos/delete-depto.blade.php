<div>
    <button wire:click="ConfirmDelete({{$deptoID}})" wire:loading.attr="disabled" class="tooltip">
    ...
    <x-dialog-modal wire:model="modal" class="flex items-center">
        ...
        <x-slot name="footer" >
            <div class="w-full flex justify-center gap-3">
                <x-danger-button class="mr-2" wire:click="deleteDepto({{$deptoID}})" wire:loading.attr="disabled">
                    Aceptar
                </x-danger-button>
