...
class Tickets extends Component
{
    ...
    public function getTicketsQueryProperty()
    {
        ...
        $query->whereNotIn('tickets.status', ['Cerrado', 'Por abrir']);
        ...
        return $query
            ...
            ->when($this->sortField, function ($query) {
                if(in_array($this->sortField,['user_id', 'solicitante_id'])){//si el capo es cliente o agente
                    return $query->join('users as u','u.id','=','tickets.'.$this->sortField)->select('tickets.*')->orderBy('u.name',$this->sortDirection);
                }else{
